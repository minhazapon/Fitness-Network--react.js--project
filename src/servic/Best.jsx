...
const Best = () => {
    return (
        <div className=" mb-10 mt-10 ml-10 mr-10">
            ...
            <div className=" animate__animated animate__flip animate__repeat-2  shadow-xl border-[1px] border-black  h-[340px] w-[250px] p-5">
              <img className="  h-[50px]" src="  https://i.ibb.co/gJJLQh4/fitness.png  " alt="" />  
