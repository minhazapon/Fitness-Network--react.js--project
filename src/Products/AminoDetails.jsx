...
const AminoDetails = ({amino}) => {

    const ami = () => toast("Order Done");

    const {image, name, details, price} = amino
            ...
            <div className="card w-96 h-[550px] text-white  bg-black shadow-xl border-[3px]  border-yellow-400 ">
              ...
              <div className="card-body items-center text-center">
               ...
               <div className="card-actions">
                   ...
                   <div>
                    <a href="#_" onClick={ami} className="relative  inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-white rounded-full shadow-md group">
